...
namespace Dapper
{
    ...
    public static class SqlHelper
    {
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, object, object, object, object, object, object>(2, storedProcedure, param, outParam, transaction, commandTimeout, CommandType.StoredProcedure, connectionString);
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, object, object, object, object, object, object>(2, sql, param, outParam, transaction, commandTimeout, CommandType.Text, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1]
            );
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, object, object, object, object, object>(3, storedProcedure, param, outParam, transaction, commandTimeout, CommandType.StoredProcedure, connectionString);
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, object, object, object, object, object>(3, sql, param, outParam, transaction, commandTimeout, CommandType.Text, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1],
                (IEnumerable<T3>)lists[2]
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, object, object, object, object>(4, storedProcedure, param, outParam, transaction, commandTimeout, CommandType.StoredProcedure, connectionString);
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, object, object, object, object>(4, sql, param, outParam, transaction, commandTimeout, CommandType.Text, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1],
                (IEnumerable<T3>)lists[2],
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, object, object, object>(5, storedProcedure, param, outParam, transaction, commandTimeout, CommandType.StoredProcedure, connectionString);
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, object, object, object>(5, sql, param, outParam, transaction, commandTimeout, CommandType.Text, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1],
                (IEnumerable<T3>)lists[2],
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, T6, object, object>(6, storedProcedure, param, outParam, transaction, commandTimeout, CommandType.StoredProcedure, connectionString);
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, T6, object, object>(6, sql, param, outParam, transaction, commandTimeout, CommandType.Text, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1],
                (IEnumerable<T3>)lists[2],
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, T6, T7, object>(7, storedProcedure, param, outParam, transaction, commandTimeout, CommandType.StoredProcedure, connectionString);
        ...
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, T6, T7, object>(7, sql, param, outParam, transaction, commandTimeout, CommandType.Text, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1],
                (IEnumerable<T3>)lists[2],
        ...
        public static Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>, IEnumerable<TRest>> QueryMultipleSP<T1, T2, T3, T4, T5, T6, T7, TRest>(string storedProcedure, dynamic param = null, dynamic outParam = null, SqlTransaction transaction = null, int? commandTimeout = null, string connectionString = null)
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, T6, T7, TRest>(8, storedProcedure, param, outParam, transaction, commandTimeout, CommandType.StoredProcedure, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>, IEnumerable<TRest>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1],
                (IEnumerable<T3>)lists[2],
                (IEnumerable<T4>)lists[3],
                ...
                (IEnumerable<T6>)lists[5],
                (IEnumerable<T7>)lists[6],
                (IEnumerable<TRest>)lists[7]
            );
        }

        public static Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>, IEnumerable<TRest>> QueryMultipleSQL<T1, T2, T3, T4, T5, T6, T7, TRest>(string sql, dynamic param = null, dynamic outParam = null, SqlTransaction transaction = null, int? commandTimeout = null, string connectionString = null)
        {
            IEnumerable[] lists = QueryMultiple<T1, T2, T3, T4, T5, T6, T7, TRest>(8, sql, param, outParam, transaction, commandTimeout, CommandType.Text, connectionString);
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>, IEnumerable<TRest>>(
                (IEnumerable<T1>)lists[0],
                (IEnumerable<T2>)lists[1],
                (IEnumerable<T3>)lists[2],
        ...
        private static IEnumerable[] QueryMultiple<T1, T2, T3, T4, T5, T6, T7, TRest>(int readCount, string sql, dynamic param = null, dynamic outParam = null, SqlTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null, string connectionString = null)
        {
            CombineParameters(ref param, outParam);
        ...
        public static DataSet ToDataSet<T1, T2, T3, T4, T5, T6, T7, TRest>(this Tuple<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>, IEnumerable<T6>, IEnumerable<T7>, IEnumerable<TRest>> instances, string[] typeNames = null, MemberTypes memberTypes = MemberTypes.Field | MemberTypes.Property, DataSet dataSet = null)
        {
            if (instances == null)
                return null;
            ...
            dataSet.Tables.Add(ToDataTable(instances.Item6, typeof(T6), (typeNames != null && typeNames.Length > 5 ? typeNames[5] : null), memberTypes, null));
            dataSet.Tables.Add(ToDataTable(instances.Item7, typeof(T7), (typeNames != null && typeNames.Length > 6 ? typeNames[6] : null), memberTypes, null));
            dataSet.Tables.Add(ToDataTable(instances.Rest, typeof(TRest), (typeNames != null && typeNames.Length > 7 ? typeNames[7] : null), memberTypes, null));
    ...
    partial class DynamicParameters
    {
        ...
        public DynamicParameters(string name, object value = null, DbType? dbType = null, ParameterDirection? direction = null, int? size = null)
            : this()
        {
            Add(name, value, dbType, direction, size);
        }

        public DynamicParameters(string name, object value = null, SqlDbType? sqlDbType = null, ParameterDirection? direction = null, int? size = null)
            : this()
        {
            Add(name, value, sqlDbType, direction, size);
        }

        public void Add(string name, object value = null, SqlDbType? sqlDbType = null, ParameterDirection? direction = null, int? size = null)
        {
            Add(name, value, (sqlDbType != null ? sqlDbTypeMap[sqlDbType.Value] : (DbType?)null), direction, size);
        }
